	...
	$(document).ready(function(){
		...
		if ($("#map-canvas").length>0) {
			...
			function initialize() {
				...
				var infowindow_marker_1 = new google.maps.InfoWindow({ content: 'Optica Colon - Galeria Planeta' });
				google.maps.event.addListener(marker_1, 'click', function() {  
                    infowindow_marker_1.open(map, marker_1);
                });
				var infowindow_marker_2 = new google.maps.InfoWindow({ content: 'Optica Colon - Av. Colon 332' });
